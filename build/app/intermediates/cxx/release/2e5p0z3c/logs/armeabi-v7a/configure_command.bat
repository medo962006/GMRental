...
"C:\\Users\\ahmed\\AppData\\Local\\Android\\Sdk\\cmake\\3.22.1\\bin\\cmake.exe" ^
  ...
  "-DCMAKE_LIBRARY_OUTPUT_DIRECTORY=C:\\Users\\ahmed\\GMRental\\hostel_management\\build\\app\\intermediates\\cxx\\release\\2e5p0z3c\\obj\\armeabi-v7a" ^
  "-DCMAKE_RUNTIME_OUTPUT_DIRECTORY=C:\\Users\\ahmed\\GMRental\\hostel_management\\build\\app\\intermediates\\cxx\\release\\2e5p0z3c\\obj\\armeabi-v7a" ^
  "-BC:\\Users\\ahmed\\GMRental\\hostel_management\\build\\.cxx\\release\\2e5p0z3c\\armeabi-v7a" ^
  -GNinja ^
  -Wno-dev ^
  --no-warn-unused-cli ^
